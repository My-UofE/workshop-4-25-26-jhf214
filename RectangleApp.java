...
public class RectangleApp {
	...
	public static void main( String[] args ) {
		...
		System.out.println("myRect1 - Width: "+myRect1.getWidth()+", Height: "+myRect1.getHeight());

	 	myRect2.scale(1,3); // should change height to 24 with width unchanged
		System.out.println("myRect2 - Width: "+myRect2.getWidth()+", Height: "+myRect2.getHeight());

		myRect3.scale(15,10); // should scale to width 15, height 10
		System.out.println("myRect3 - Width: "+myRect3.getWidth()+", Height: "+myRect3.getHeight());
		...
		boolean overlappingResult = Rectangle.areOverlapping(myRect4, myRect5);
		System.out.println( "myRect4 overlaps myRect5: "+overlappingResult);		
		

		Rectangle mySquare = new Rectangle(40.0, 40.0, 500, 500); 
		boolean isSquareResult = mySquare.isSquare();
		System.out.println( "mySquare is square: "+isSquareResult);	
