...
public class RectangleApp {
	...
	public static void main( String[] args ) {
		...
		System.out.println("myRect1 - Width: "+myRect1.width+", Height: "+myRect1.height);

	 	myRect2.scale(1,3); // should change height to 24 with width unchanged
		System.out.println("myRect2 - Width: "+myRect2.width+", Height: "+myRect2.height);

		myRect3.scale(15,10); // should scale to width 15, height 10
		System.out.println("myRect3 - Width: "+myRect3.width+", Height: "+myRect3.height);
		...
		Rectangle myRect7 = new Rectangle(40.0, 40.0, 500, 500); 
		boolean isSquareResult = myRect7.isSquare();
		System.out.println( "myRect7 is square: "+isSquareResult);	
	}
}
